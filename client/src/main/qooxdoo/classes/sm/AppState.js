 ...
 * Application state
 */
qx.Class.define("sm.AppState", {
    extend: qx.core.Object,

    events: {
        /**
         * Event data: AppState.__stateObject
         */
     ...
     * @param actions {sm.conn.Actions}
     */
    construct: function (urlName, actions) {
        this.base(arguments);
        this.__actions = actions;
        this.__urlName = urlName;
        this.__url = actions.getUrl(urlName);
    ...
    members: {
        ...
        setStateProperty: function (pname, pval) {
            ...
            var url = this.__actions.getRestUrl(this.__urlName, pname);
