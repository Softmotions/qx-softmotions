...
qx.Class.define("sm.store.Json", {
    ...
    members :
    {
        ...
        _applyRequest: function(req, old) {
            if (old != null) {
                old.removeListener("completed", this.__requestCompleteHandler, this);
                old.removeListener("changeState", this.__requestChangeStateHandler, this);
            }
